...
},{"assert":11,"global/document":5,"global/window":6}],13:[function(require,module,exports){
(function (process){
(function (global, factory) {
...
function loadCurse(cursoKey) {
  return firebase.database().ref().child('curso/' + cursoKey).once('value').then(function (result) {
...
function btnUpdate(cursoKey) {
  ...
  if (name == "" || type_name == "" || date == "" || img == "" || description == "") {
    ...
    var FBRefaux = firebase.database().ref().child('curso/' + cursoKey);
...
function btnSave() {
  ...
  if (name == "" || type_name == "" || date == "" || img == "" || description == "") {
    ...
    var FBRefaux = firebase.database().ref().child('curso/');
    console.log('FBRef:', FBRefaux);
...
function loadImages(item, referenceToOldestKey) {
  ...
  if (referenceToOldestKey == true) {
    ...
    return firebase.database().ref().child('curso').orderByKey().limitToLast(item).once('value').then(function (result) {
      var datos = result.val();
      if (datos == null) {
    ...
    return firebase.database().ref().child('curso').orderByKey().endAt(referenceToOldestKey).limitToLast(item).once('value').then(function (result) {
      var datos = result.val();
      if (datos == null) {
        console.log('No hay datos');
        return null;
...
},{"./btnAdd":21,"./card":22,"./footer":23,"./header":24,"./templateEmpty":26,"empty-element":4,"page":13,"yo-yo":15}],26:[function(require,module,exports){
'use strict';
...
},{"./curso":18,"./firebase":20,"./home":25,"page":13}]},{},[27]);
